            ...
            <div className="container">
                ...
                <div id="carouselExampleCaptions" className="carousel slide" data-bs-ride="carousel">
                    ...
                    <div className="carousel-item active">
                        ...
                        {/* client picture  */}
                        <div className="testimonials__picture">
                        <img src={"images/testimonials/client-3.jpg"} alt="client-3" className="rounded-circle img-fluid" />
                        </div>
                        {/* client name & role  */}
                        <div className="testimonials__name">
                    ...
                    <div className="carousel-item">
                        ...
                        {/* client picture  */}
                        <div className="testimonials__picture">
                        <img src={"images/testimonials/client-4.jpg"} alt="client-4" className="rounded-circle img-fluid" />
                        </div>
                        {/* client name & role  */}
                        <div className="testimonials__name">
